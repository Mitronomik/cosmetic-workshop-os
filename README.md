...
The current focus is the evidence-only `CR-006` diagnostic. C1 and C2 are **COMPLETED**. C3-I (PR #159), C3-II-A (PR #161) and C3-II-B1 (PR #163) are **DONE — MERGED AND EXACT-HEAD VERIFIED**. C3 remains **INCOMPLETE**. `CR-009` is accepted and implemented for report documents only, while C3-II-B2 remains blocked by CR-006 and C3-II-B3 by CR-004. Durable contracts: `docs/audit-log.md` and `docs/decisions/0013-file-backed-artifact-audit-semantics.md`.
