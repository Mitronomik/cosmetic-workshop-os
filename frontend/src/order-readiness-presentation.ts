import { renderReadinessFinancialSection } from './production-financial-presentation.js';
import type { ReadinessFinancials } from './production-financial-contract.js';
...
export type ProductionReadinessResponse = ReadinessFinancials & { order_id: number; can_produce: boolean; status: ProductionReadinessStatus; blocking_issues: ProductionReadinessIssue[]; warnings: ProductionReadinessIssue[]; ingredients: ProductionReadinessIngredientLine[]; packaging: ProductionReadinessPackagingLine[]; generated_at: string | null };
