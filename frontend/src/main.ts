...
const onboardingStepUi: Record<string, OnboardingStepUi> = {
  ...
  first_production: { hint: 'Перед производством приложение проверяет материалы, тару, предупреждения и расчётные показатели.', sections: ['Заказы', 'Производство'] },
...
function plannedSectionPlaceholder(section: NavigationSection) {
  const copy: Record<string, { title: string; now: string }> = {
    ...
    Производство: { title: 'Производство', now: 'История изготовленных партий доступна в отдельном журнале просмотра.' },
    ...
    Отчеты: { title: 'Отчёты', now: 'Сводные отчёты доступны в разделе /reports. Если вы видите этот экран, вернитесь через пункт «Отчёты» в навигации.' },
