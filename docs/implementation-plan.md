...
Статус: `IN PROGRESS` — closure PR is under review and required browser smoke is pending.

### Scope

Slice A1 closure remains under review. Do not mark A1 complete until the corrected GitHub head is reviewed, required browser smoke passes, and no A1 blocker remains.
