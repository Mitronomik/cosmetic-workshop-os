...
Статус: `IN PROGRESS — A3.7 Orders structured validation READY`
...
Slice A3 as a whole remains IN PROGRESS. The next READY focused runtime slice is **A3.7 — Orders structured validation**. No future GitHub PR number is assigned. A3.7 must be implemented separately and limited to existing Order create/edit form validation and safe mutation lifecycle.
