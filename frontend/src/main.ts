...
import { AlertsFeedbackLifecycle, alertsPresentation, bindAlertsActionControls, filterDisplayedAlerts, selectAlertFocusTarget, type AlertFilters } from './alerts-feedback.js';
...
function clearRouteOwnedFeedbackOnNavigation(nextSection: NavigationSection) {
  ...
  if (nextSection === 'Алерты') alertsLifecycle.enterRoute(); else alertsLifecycle.leaveRoute();
}
