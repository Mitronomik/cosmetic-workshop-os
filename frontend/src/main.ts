...
function changeManualPurchaseItemType(type: PurchaseSuggestionItemType) { purchaseSuggestionsState.manualForm.item_type = type; purchaseSuggestionsState.manualForm.item_id = ''; purchaseSuggestionsState.manualForm.unit = type === 'ingredient' ? 'g' : 'pcs'; render(); }
