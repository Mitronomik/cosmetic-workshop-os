...
- `C2-II` — неизменяемые финансовые снапшоты внутри транзакции подтверждения производства, включая обязательные-но-nullable ключи контекста ставки и конфликт `tax_rate_context_stale`;
