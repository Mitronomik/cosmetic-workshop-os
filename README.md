...
Slice A4 is now active. **A4.1 — Shared responsive table containment foundation for `/ingredient-lots`** is DONE (PR #125 merged at `50c44ff0919401d51c165d6ebec1266c688bfb08`; runtime head `effb5ee270c9fbddc777e57c41ad0b53acd77f9d`). The current focused runtime slice is **A4.2 — responsive table containment for `/orders`**. `/clients`, `/inventory`, and `/packaging-items` remain future A4 follow-ups.
