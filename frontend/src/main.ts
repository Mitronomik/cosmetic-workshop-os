...
function bindEvents(root: HTMLElement) {
  ...
  root.querySelector<HTMLButtonElement>('[data-action="new-packaging-item"]')?.addEventListener('click', openPackagingCreateForm);
...
function openPackagingCreateForm() {
  ...
  packagingItemsState.formMode = 'create'; packagingItemsState.showCreateForm = true; packagingItemsState.form = emptyPackagingItemForm(); packagingItemsState.assignmentDraft = emptyAssignmentDraft(); packagingItemsMessage = ''; packagingItemsError = ''; render();
}
