...
B1 is internal Python launcher/C4-I proof binding. It adds no dependency, helper executable, package resource, background service or persistent secret. Packaging behavior remains unchanged.
