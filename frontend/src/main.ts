...
type ClientRecipesState = { items: ClientRecipe[]; clients: Client[]; templates: RecipeTemplate[]; versions: RecipeVersion[]; selectedTemplateId: number | null; selectedDetail: ClientRecipeDetail | null; form: ClientRecipeFormState; includeInactive: boolean; detailStatus: ClientRecipeDetailStatus; showCreateForm: boolean; filters: { search: string; status: ClientRecipeStatusFilter; clientId: string } };
...
let clientRecipesState: ClientRecipesState = { items: [], clients: [], templates: [], versions: [], selectedTemplateId: null, selectedDetail: null, form: emptyClientRecipeForm(), includeInactive: false, detailStatus: 'idle', showCreateForm: false, filters: { search: '', status: 'active', clientId: '' } };
...
function openClientRecipeCreate() { if (clientRecipesState.showCreateForm) { saveClientRecipeFormFromDom(); render(); requestAnimationFrame(() => document.querySelector<HTMLInputElement>('[data-field="client-recipe-title"]')?.focus()); return; } clientRecipesState.showCreateForm = true; clientRecipesState.selectedDetail = null; clientRecipesState.detailStatus = 'idle'; clientRecipesState.form = emptyClientRecipeForm(); clientRecipesState.versions = []; clientRecipesState.selectedTemplateId = null; clientRecipesMessage = ''; clientRecipesError = ''; render(); requestAnimationFrame(() => document.querySelector<HTMLInputElement>('[data-field="client-recipe-title"]')?.focus()); }
function hideClientRecipeCreate() { clientRecipesState.showCreateForm = false; clientRecipesState.form = emptyClientRecipeForm(); clientRecipesState.versions = []; clientRecipesState.selectedTemplateId = null; render(); }
function closeClientRecipeDetail() { clientRecipesState.selectedDetail = null; clientRecipesState.detailStatus = 'idle'; render(); }
