...
Статус: `IN PROGRESS — A3.1 Ingredient Lots validation migration`

Текущий под-срез A3.1: только `/ingredient-lots` create/edit. `/stock-movements` и все остальные кандидаты A3 остаются pending для отдельных PR.
