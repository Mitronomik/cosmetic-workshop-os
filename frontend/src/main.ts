...
function bindEvents(root: HTMLElement) {
  ...
  root.querySelector<HTMLButtonElement>('[data-action="hide-recipe-create"]')?.addEventListener('click', hideRecipeCreateForm);
...
function closeRecipeDetail() { saveVersionFormFromDom(); recipesState.selectedTemplate = null; recipesState.versions = []; recipesState.selectedVersionDetail = null; recipesState.versionDetailStatus = 'idle'; recipesState.calculation = null; calculationStatus = 'idle'; recipesMessage = ''; recipesError = ''; render(); }
