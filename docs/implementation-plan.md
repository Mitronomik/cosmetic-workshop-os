...
Статус: `DONE` — A1 closure completed the healthy/offline topbar copy, Import capability correction, Demo Data labels, Backup and Export copy, Reports and Report Documents copy, Help Center product language, navigation readiness corrections, final static terminology sweep, and directly affected user/help documentation sync.

### Scope

Slice A1 is closed by the focused language/navigation/documentation cleanup. No future PR number is assigned here.
