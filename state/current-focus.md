...
Current focused implementation slice: Slice A3.3 / PR #117 — structured validation for Recipe Template creation and immutable Recipe Version creation on `/recipes`. Published PR branch is `codex/add-structured-validation-for-recipes`; pre-correction published head was `718d8cafa62dd9bed87f8eab4e1d7896427a9a9d`.
